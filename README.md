# Nahyeon Kim  
안녕하세요! AI가 너무 재미있는 김나현입니다. 저는 **인하대학교 데이터사이언스학과**에 재학 중이며, **AI Researcher 및 Engineer**를 목표로 하고 있습니다. 주요 관심 분야는 **설명 가능한 AI(XAI), 추천시스템**입니다.  
...
💼 **Internship & Research**  
- **Undergraduate Research Intern**, AI Medical Center, SNUBH `2024.12 ~ Present`
